...
NDiplomacy = {
	...
	VOLUNTEERS_DIVISIONS_REQUIRED = 3000,				-- This many divisons are required for the country to be able to send volunteers.
...
NProduction = {
	...
	MAX_CIV_FACTORIES_PER_LINE = 50,	-- Max number of factories that can be assigned a single production line.
...
NNavy = {
	...
	NAVAL_TRANSFER_BASE_NAVAL_DIST_MULT = 20,						-- Multiplier for the cost of naval movement ( compared to land movement ) when deciding what ports to use for nava
...
NAI = {
	...
	SEND_VOLUNTEER_EVAL_BASE_DISTANCE = 0.0,  -- How far away it will evaluate sending volunteers if not a major power
	SEND_VOLUNTEER_EVAL_MAJOER_POWER = 0.0, 	-- How willing major powers are to send volunteers.
	SEND_VOLUNTEER_EVAL_CONTAINMENT_FACTOR = 0.0, -- How much AI containment factors into its evaluation of sending volunteers.
