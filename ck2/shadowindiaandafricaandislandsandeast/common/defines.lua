...
NDiplomacy = {
	...
	MAX_DIPLO_DISTANCE = 350,									-- Most diplomacy is disallowed if two rulers are too distant
	...
	MAX_DIPLO_DISTANCE_SAME_CULTURE_GROUP = 50,				-- Bonus to max diplo distance for being of the same culture group
...
NEngine = {
	...
	COURT_PRUNE_SIZE = 5, 				-- Courts larger than this will be checked for pruning each month
	PRUNE_MINIMAL_AGE = 12,				-- Minimum age for a courtier to be prunable if considered irrelevant
